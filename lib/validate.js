...
function validateLeadPayload(body) {
  ...
  /* Normalise en-dash (the form's "1–2 Months") to ASCII hyphen so both
     spellings validate against TIMELINE_OPTIONS below. */
  const timeline = oneLine(b.timeline, 30).replace(/\u2013/g, "-");
