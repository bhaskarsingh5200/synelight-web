...
/* Tiny retry: serverless cold starts / undici DNS hiccups occasionally drop the
   connection; one retry after a short pause covers the common transient case. */
async function resenFetchOnce(payload) {
...
async function sendViaResend(to, subject, text) {
  ...
  let res;
  try {
    res = await resenFetchOnce(payload);
  } catch (err) {
