...
async function removeLead(id) {
  if (supabase.isConfigured()) return supabase.remove(id);
  return jsonstore.remove(id);
}

module.exports = { createLead, getLead, listLeads, updateLead, removeLead, statsByStatus, activeEngine };
